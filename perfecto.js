...
(function($) {
  $(document).ready(function() {
    ...
    var overlay_panel_url = Drupal.settings.basePath + 'admin/config/development/perfecto/overlay_panel';

    $.ajax({
      url: overlay_panel_url,
    ...
    var init_perfecto = function() {
      ...
      (function() {
          ...
          filename = $.cookie('overlay_filename')?$.cookie('overlay_filename'):$('#perfecto__imageoverlaycontrols-files option:first').val(),
          lock = false,
          dragging = false,
          overlay_position_x,
          overlay_position_y,
          ...
          */
          ...
          $('#perfecto__imageoverlaycontrols-files').change(function() {
            ...
            overlay.attr('src', filename_full);
            $.cookie('overlay_filename', filename);
          });

          var filename_full = Drupal.settings.basePath + 'sites/default/files/mod_perfecto/unmanaged/' + filename;

          var overlay = $('<img id="perfecto__imageoverlaycontrols_img" src="' + filename_full + '" alt="" />');
          overlay.css({
              "position": "absolute",
              "z-index" : -99999,
              "top"     : top+"px",
